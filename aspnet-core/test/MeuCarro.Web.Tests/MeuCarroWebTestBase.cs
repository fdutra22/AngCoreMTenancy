...
{
    public abstract class MeuCarroWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MeuCarroWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MeuCarroWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MeuCarroDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MeuCarroDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MeuCarroDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MeuCarroDbContext, Task<T>> func)
        {
            T result;
