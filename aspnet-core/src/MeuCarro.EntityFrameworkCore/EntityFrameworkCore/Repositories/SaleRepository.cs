...
{
    public class SaleRepository : MeuCarroRepositoryBase<Sale, int>, ISaleRepository
    {
        private readonly IActiveTransactionProvider _transactionProvider;

        public SaleRepository(IDbContextProvider<MeuCarroDbContext> dbContextProvider, IActiveTransactionProvider transactionProvider) : base(dbContextProvider)
        {
