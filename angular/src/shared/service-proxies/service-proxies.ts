...
export class ParametersServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ParameterDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/Parameters/GetAll?";
        if (sorting === null)
            throw new Error("The parameter 'sorting' cannot be null.");
        else if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ParameterDtoPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ParameterDtoPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ParameterDtoPagedResultDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = ParameterDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ParameterDtoPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<ParameterDto> {
        let url_ = this.baseUrl + "/api/services/app/Parameters/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ParameterDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ParameterDto>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<ParameterDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ParameterDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ParameterDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: ParameterDto | undefined): Observable<ParameterDto> {
        let url_ = this.baseUrl + "/api/services/app/Parameters/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<ParameterDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: ParameterDto | undefined): Observable<ParameterDto> {
        let url_ = this.baseUrl + "/api/services/app/Parameters/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ParameterDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Parameters/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&"; 
...
export class ReportsServiceProxy {
     ...
     * @return Success
     */
    getAll(arquivo: string, tipo : boolean): Observable<any> {

        let url_ = this.baseUrl + "/api/services/app/Reports/" + arquivo + "?tipo=" + tipo;

        url_ = url_.replace(/[?&]$/, "");

        let headers = new HttpHeaders();
        //headers = headers.set('Accept', 'application/pdf');
        return this.http.post(url_, { path: this.baseUrl }, { observe: 'response', responseType: 'blob', });
...
@Injectable()
export class SaleProductsServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
...
export class SaleDto implements ISaleDto {
    ...
    init(data?: any) {
        if (data) {
            this.valorVendido = data["valorVendido"];
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["valorVendido"] = this.valorVendido;
        data["carroId"] = this.carroId;
        return data; 
    }
...
export class ParameterDto implements IParameterDto {
    id: number;
    margemIdealPercentual: number;
    vendaMinimaPercentual: number;

    constructor(data?: IParameterDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            this.id = data["id"];
            this.margemIdealPercentual = data["margemIdealPercentual"];
            this.vendaMinimaPercentual = data["vendaMinimaPercentual"];
        }
    }

    static fromJS(data: any): ParameterDto {
        data = typeof data === 'object' ? data : {};
        let result = new ParameterDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["vendaMinimaPercentual"] = this.vendaMinimaPercentual;
        data["margemIdealPercentual"] = this.margemIdealPercentual;
        return data;
    }
...
export class ParameterDtoPagedResultDto implements IParameterDtoPagedResultDto {
    totalCount: number;
    items: ParameterDto[] | undefined;

    constructor(data?: IParameterDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (Array.isArray(data["items"])) {
                this.items = [] as any;
                for (let item of data["items"])
                    this.items.push(ParameterDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ParameterDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ParameterDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ParameterDtoPagedResultDto {
        const json = this.toJSON();
        let result = new ParameterDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IParameterDtoPagedResultDto {
    totalCount: number;
    items: ParameterDto[] | undefined;
}
