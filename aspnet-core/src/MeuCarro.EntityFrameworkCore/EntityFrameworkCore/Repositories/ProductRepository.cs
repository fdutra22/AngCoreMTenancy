...
{
    public class ProductRepository : MeuCarroRepositoryBase<Product, int>, IProductRepository
    {
        private readonly IActiveTransactionProvider _transactionProvider;

        public ProductRepository(IDbContextProvider<MeuCarroDbContext> dbContextProvider, IActiveTransactionProvider transactionProvider) : base(dbContextProvider)
        {
